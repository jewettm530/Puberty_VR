...
HEART_RATE_SCRIPTS_DIR = SCRIPTS_DIR / "heart_rate"
EEG_SCRIPTS_DIR = SCRIPTS_DIR / "eeg"
MULTIMODAL_SCRIPTS_DIR = SCRIPTS_DIR / "multimodal"
...
for folder in [
    ...
    HEART_RATE_SCRIPTS_DIR,
    EEG_SCRIPTS_DIR,
    MULTIMODAL_SCRIPTS_DIR,
]:
